...
<form action = "search.php" method = "POST">
    <div class="search">
      ...
      <!--**************** The end of Java Script   **************-->
       ...
       where Photographer_User_User_email ='akramsaber45@gmail.com' limit 1";
...
where User_email = 'akramsaber45@gmail.com'
...
;";
    $ID++;
       ...
       WHERE  User_User_email = 'akramsaber45@gmail.com' limit 1 ";
                $result2 = mysqli_query($conn,$sql2);
                $quertResult2  = mysqli_num_rows($result2);
                if($quertResult2 > 0)
                {
     ...
     where Photographer_User_User_email ='akramsaber45@gmail.com' ORDER BY photo_id DESC limit 6";
