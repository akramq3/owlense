...
<html lang="en">
  <head>
    ...
    <title>owlense products category</title>
    <link rel="stylesheet" href="category_procutspage.css" />
  </head>
  <body>
    <div class="main">
      <div class="navbar">
...
<form action = "search.php" method = "POST">
      ...
      <div class="content">
        ...
        <button class="cnn">
          ...
          <a href="#">PRODUCTS PHOTOGRAPHERS</a></button>
      </div>
      <br /><br /><br /><br />
                  ...
                  <div class="swiper-slide card">
                    <div class="card-content">
                      ...
                      <div class="name-profession">
                        ...
                        inner join product on Photo_Categories_Photographer_User_User_email = user.User_email
                        where Photo_Categories_Categories_Categories_type in(
                        select  Photo_Categories_Categories_Categories_type
                        from product
                        where Photo_Categories_Categories_Categories_type ='product') and product_Category_id = 5 ;";
                      $result = mysqli_query($conn,$sql);
                      $quertResult = mysqli_num_rows($result);
      ...
      inner join product on Photo_Categories_Photographer_User_User_email = profile_photo.Photographer_User_User_email
      where Photo_Categories_Categories_Categories_type in(
      select  Photo_Categories_Categories_Categories_type
      from product
      where Photo_Categories_Categories_Categories_type ='product') and product_Category_id = 6 ;";
       ...
       select  Photo_Categories_Categories_Categories_type
       from product
       where Photo_Categories_Categories_Categories_type ='product') and product_Category_id = 1 ;";
                   $res1 = mysqli_query($conn,  $sql1);
                   if (mysqli_num_rows($res1) > 0) {
                     while ($images = mysqli_fetch_assoc($res1)) {
                       ?>
