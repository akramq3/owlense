...
<html lang="en">
  <head>
    ...
    <title>owlense social occasion category</title>
    <link rel="stylesheet" href="category_socialoccasionpage.css" />
  </head>
  <body>
    <div class="main">
      <div class="navbar">
    ...
    <form action = "search.php" method = "POST">
      ...
      <div class="content">
        ...
        <button class="cnn">
          ...
          <a href="#">SOCIAL OCCASION PHOTOGRAPHERS</a>
        </button>
      </div>
      <br /><br /><br /><br />
              ...
              <button class="hireMe">Book Me</button>
                  ...
                  <div class="swiper-slide card">
                    <div class="card-content">
                      ...
                      inner join socialoccasion on Photo_Categories_Photographer_User_User_email = profile_photo.Photographer_User_User_email
                      where Photo_Categories_Categories_Categories_type in(
                      select  Photo_Categories_Categories_Categories_type
                      from socialoccasion
                      where Photo_Categories_Categories_Categories_type ='socialoccasion') and socialoccasion_Category_id = 1 ;";
                      ...
                      <div class="name-profession">
                        ...
                        inner join socialoccasion on Photo_Categories_Photographer_User_User_email = user.User_email
                        where Photo_Categories_Categories_Categories_type in(
                        select  Photo_Categories_Categories_Categories_type
                        from socialoccasion
                        where Photo_Categories_Categories_Categories_type ='socialoccasion') and socialoccasion_Category_id = 1 ;";
                  ...
                  <div class="swiper-slide card">
                    <div class="card-content">
                      ...
                      <div class="name-profession">
                        ...
                        select  Photo_Categories_Categories_Categories_type
                        from socialoccasion
                        where Photo_Categories_Categories_Categories_type ='socialoccasion') and socialoccasion_Category_id = 3 ;";
                      $result = mysqli_query($conn,$sql);
                      $quertResult = mysqli_num_rows($result);
                  ...
                  <div class="swiper-slide card">
                    <div class="card-content">
                      ...
                      <div class="media-icons">
                        ...
                        <div class="name-profession">
                          <span class="name">mohamed khailed</span>
                          <span class="profession">socialoccasion</span>
                        </div>
