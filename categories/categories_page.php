...
<html lang="en">
  <head>
    <title>owlense categories</title>
      ...
      <div class="content">
        ...
        <table>
          <tr>
            <td>
              <button class="cn">
                <a href="category_portraitpage.php">PORTRAIT</a></button
              ><br /><br /><br /><br /><br />
            </td>
            <td>
              <button class="cn">
                <a href="category_nature_page.php">NATURE</a></button
              ><br /><br /><br /><br /><br />
            </td>
          </tr>
          <tr>
            <td>
              <button class="cn">
                <a href="category_productspage.php">PRODUCTS</a></button
              ><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
            </td>
            <td>
              <button class="cn">
                <a href="category_socialoccasion.php"
                  >SOCIAL OCCASION</a
                ></button
              ><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
            </td>
