...
<html lang="en">
  <head>
    ...
    <title>owlense nature category</title>
    <link rel="stylesheet" href="category_naturepage.css" />
  </head>
  <body>
    <div class="main">
      <div class="navbar">
...
<form action = "search.php" method = "POST">
      ...
      <div class="content">
        ...
        <button class="cnn">
          ...
          <a href="#">NATURE PHOTOGRAPHERS</a></button>
      </div>
      <br /><br /><br /><br />
      ...
      where Photo_Categories_Categories_Categories_type ='nature') and nature_Category_id = 1 ;";
                  ...
                  if (mysqli_num_rows($res1) > 0) {
                    while ($images = mysqli_fetch_assoc($res1)) {
                      ...
                      inner join nature on Photo_Categories_Photographer_User_User_email = user.User_email
                      where Photo_Categories_Categories_Categories_type in(
                      select  Photo_Categories_Categories_Categories_type
                      from nature
                      where Photo_Categories_Categories_Categories_type ='nature') and nature_Category_id = 1 ;";
                      ...
                      <div class="button">
                        <button class="aboutMe" onclick="location.href='http://localhost/graduation project/mohamedmohsen30@gmail.com.php'">My Page</button>
   ...
   <img src="images/img3.jpg" alt="" />
                      ...
                      <div class="name-profession">
                        <span class="name">Ramy Mahmoud</span>
                        <span class="profession">Nature</span>
                      </div>
                  ...
                  <div class="swiper-slide card">
                    <div class="card-content">
                      ...
                      <div class="name-profession">
                        <span class="name">gamal hady</span>
                        <span class="profession">Nature</span>
                      </div>
